...
describe('Memento Solution', () => {
  it('should be set state', () => {
    ...
    expect(editor.getState()).toEqual({ text: 'a', curX: 1, curY: 2 })
  ...
  it('should be undo', () => {
    ...
    historial.addState(editor)
    expect(editor.getState()).toEqual({ text: 'c', curX: 5, curY: 6 })
    historial.undo()
    expect(editor.getState()).toEqual({ text: 'b', curX: 3, curY: 4 })
  })
  it('should be redo', () => {
    const editor = new Editor(iState)
    const historial = new Historial()
